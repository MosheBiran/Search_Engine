    ...
    def parse_sentence(self, text):
        ...
        while i < len(text_tokens):
            ...
            #     continue
                ...
                lst_entity_to_send = [text_tokens[i]]
                i += 1
        ...
        after_parse_lst = [x.lower() for x in after_parse_lst if x not in self.stop_words and x not in self.punc and not ' ' in x and not '...' in x and not '\n' in x]
